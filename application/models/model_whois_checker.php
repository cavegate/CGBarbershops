...
class Model_whois_checker extends CI_Model
{
     ...
     * @return string the extention
     */
    public static function getExtention($domain)
    {
        $domain_parts = explode(".", $domain);
        return strtolower(array_pop($domain_parts));
    }

    /**
     * @param $whoisserver string the server of the whois
     * @param $domain string the domain
     * @return string the whois answer
     */
    ...
    /**
     * @param $domain string the domain
     * @return bool if the domain is valid or not
     */
